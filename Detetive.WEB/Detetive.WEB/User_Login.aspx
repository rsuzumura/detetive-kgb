<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Login.aspx.cs" Inherits="Detetive.WEB.User_Login" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login - Detetive (Jogo)</title>
                ...
                <table class="btable" style="width: 410px; text-align: center">
                    <tr>
                        <td class="blc">
                            ...
                            <div class="blkc" style="height: 230px;" align="center">
                                <br />
                                <asp:Login ID="Login1" runat="server" FailureText="Usuário ou senha incorretos.">
                                    <LayoutTemplate>
                                        <table cellspacing="4" cellpadding="4">
                                            ...
                                            <tr align="center">
                                                <td colspan="3">
                                                    <asp:LinkButton ID="ForgetPassword" runat="server" Text="Recuperar Senha" OnClick="ForgetPassword_Click" />
                                                </td>
                                            </tr>
                                            <tr align="center">
                                                <td colspan="3">
                                                    <asp:Button ID="ChangePassword" runat="server" Text="Alterar Senha" OnClick="ChangePassword_Click" />
                                                    <asp:Button ID="Create" runat="server" Text="Cadastrar" OnClick="Create_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </LayoutTemplate>
