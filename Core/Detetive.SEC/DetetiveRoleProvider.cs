...
{
    public sealed class DetetiveRoleProvider : RoleProvider
    {
        private string eventSource = "DetetiveRoleProvider";
        ...
        public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config)
        {
            ...
            if (String.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "Detetive MS SQL Server Role provider");
            }
