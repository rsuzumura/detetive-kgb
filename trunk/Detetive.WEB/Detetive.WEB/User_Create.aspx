<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Create.aspx.cs" Inherits="Detetive.WEB.User_Create" %>
        ...
        <div id="page" align="center">
            ...
            <table class="btable">
                <tr>
                    <td class="blc">
                        <div class="header">
                            <asp:Label ID="lblTitle" runat="server">Cadastro de Novo Usuário</asp:Label></div>
                        <div class="blkc">
                            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" AnswerLabelText="Resposta:"
                                ...
                                Width="100%">
                                <WizardSteps>
                                    <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" Title="Por favor, preencha os dados abaixo para cadastramento da conta.">
                                        <ContentTemplate>
                                            <table border="0" class="propertiesTable">
                                                <tr class="row0">
                                                    <td align="center" colspan="3">
                                                        <asp:Label ID="lblStep0Title" CssClass="label" runat="server" Text="Por favor, preencha os dados abaixo para cadastramento da conta."></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr class="row1">
                                                    <td align="right">
                        ...
                        <br />
                        <asp:HyperLink ID="lnkLogin" CssClass="label" runat="server" NavigateUrl="User_Login.aspx">[ Efetuar a Autenticação ]</asp:HyperLink>
                    </td>
                </tr>
            </table>
        </div>
